...
from home.views import orderconfirm,wish,order_display,checkout,total,payment,delete_product,refresh,count,cartpage,updateqty,cartadd,home,subcat,produc,single,register,login,logout
